...
import { acquireReplSessionSendLease, readReplSessionRecord, upsertReplSessionRecordEntry } from "../../src/shared/repl-session-record.js";
import { createReplSubmissionDisplay } from "../../src/shared/repl-submission-display.js";
import { gnuplotStringLiteral } from "../../src/shared/repl-gnuplot.js";
...
async function fixture(t, { index = 0, runtime = "python", controlName, startWithTool = false, concurrentStart = false } = {}) {
	...
	const { default: register } = await import(`../../src/pi-repl.ts?fixture=${randomUUID()}`);
	register(pi);
...
test('cpp adapter PETSc keeps the same objects through direct edits and errors', {
	...
	const { cppStringLiteral, cppInclude } = await import('../../src/shared/repl-cpp.js');
